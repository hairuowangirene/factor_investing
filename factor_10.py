...
class factor_10():
    ...
    def generate(self):
        ...
        data_0['Close_'] = data_0['Close'] + 0.00001
        ...
        for _, ukeydf in group:
            ...
            ukeydf = returns(ukeydf, columns)
            ukeydf = ts_std(ukeydf, f"returns_{columns}_1", n=std)
            ukeydf['Ret_condition'] = np.where(ukeydf[f'returns_{columns}_1']
                                               < 0,
                                               ukeydf[f'ts_std_returns_'
                                                      f'{columns}_1_{std}'],
                                               ukeydf['Close'])
            ukeydf = ts_max(ukeydf, 'Ret_condition', n=max)
        ...
        data_0.eval(f"x = rank_max", inplace=True)
        ...
        factor.to_csv('factor_alpha_10.csv.gz')
