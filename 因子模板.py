...
class factor_alpha_1():
    ...
    def load_data(self):
        ...
        self.data_0 = pd.read_csv('/Users/irenewang/Desktop/QF603 - Quantitative Analysis/Project/ashareeodprices_total.csv.gz')
    ...
    def generate(self):
        ...
        data_0.eval('Close_Open = (Close - Open) / (Open + 0.0001)',
                    inplace=True)
        data_0.eval('log_volume = log(Volume)', inplace=True)
