...
class factor_11():
    ...
    def generate(self):
        ...
        data_0['Close_Low_High'] = (data_0['Close'] - data_0['Low']) - \
                                   (data_0['High'] - data_0['Close'])
        data_0['High_Low_Volume'] = (data_0['High'] - data_0['Low']) * \
                                    data_0['Volume']
        data_0['ratio'] = data_0['Close_Low_High'] / data_0['High_Low_Volume']
        ...
        for _, ukeydf in group:
            ...
            ukeydf = ts_sum(ukeydf, 'ratio', n = sum)
        ...
        factor.to_csv('factor_alpha_11.csv.gz')
